...
const runTestActivateCategory = async () => {
    try {
        ...
        const result = await productService.activateCategory(idCategory);
        console.log("📄 Categoria activada:", result);
    }
    catch (error) {
...
runTestActivateCategory().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=testActivateCategory.js.map