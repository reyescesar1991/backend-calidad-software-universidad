...
const runTestActivateWarehouse = async () => {
    try {
        ...
        const result = await locationService.activateWarehouse(idWarehouse);
        console.log("📄 Almacén activado:", result);
    }
    catch (error) {
...
runTestActivateWarehouse().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=testActivateWarehouse.js.map