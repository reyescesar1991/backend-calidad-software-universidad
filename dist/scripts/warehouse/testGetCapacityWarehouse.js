...
const runTestGetCapacityWarehouse = async () => {
    try {
        ...
        const result = await locationService.getCapacityWarehouse(idWarehouse);
        console.log("📄Capacidad del Almacén en pallets:", result);
    }
    catch (error) {
...
runTestGetCapacityWarehouse().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=testGetCapacityWarehouse.js.map