...
const runTestFindAllProductsStock = async () => {
    try {
        ...
        const result = await productStockService.findAllProductsStock();
        console.log("📄 Stocks de productos encontrados en base de datos:", result);
    }
    catch (error) {
...
runTestFindAllProductsStock().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=testFindAllProductsStock.js.map