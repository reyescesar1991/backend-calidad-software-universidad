...
const runTestAddAttempSecondFactorUser = async () => {
    try {
        ...
        const result = await securityAuditService.addAttempSecondFactor(idUser);
        console.log("📄 Intento de segundo factor sumado al registro de seguridad: ", result);
    }
    catch (error) {
...
runTestAddAttempSecondFactorUser().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=testAddAttempSecondFactorUser.js.map