...
const runTestViewableCategory = async () => {
    try {
        ...
        const result = await productService.viewableCategory(idCategory);
        console.log("📄 Categoria ahora visible:", result);
    }
    catch (error) {
...
runTestViewableCategory().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=testViewableCategory.js.map