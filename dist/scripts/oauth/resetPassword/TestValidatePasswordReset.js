...
const runTestVerify2FAPasswordReset = async () => {
    try {
        ...
        console.log("📄 2do factor verificado para la recuperacion de contraseña: ", result);
    }
    catch (error) {
...
runTestVerify2FAPasswordReset().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=TestValidatePasswordReset.js.map