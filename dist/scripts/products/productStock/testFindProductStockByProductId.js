...
const runTestCreateProductStock = async () => {
    try {
        ...
        const productId = validations_1.objectIdSchema.parse("67f6b81ac5e6b5a14ec501c8");
        ...
        console.log("📄 Stock de producto encontrado por id:", result);
    }
    catch (error) {
...
//# sourceMappingURL=testFindProductStockByProductId.js.map