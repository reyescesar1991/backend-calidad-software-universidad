...
const runTestFindProductByCustomId = async () => {
    try {
        ...
        const result = await productStockService.findProductByProductCustomId(productCustomId);
        console.log("📄 Stock de producto encontrado por custom id:", result);
    }
    catch (error) {
...
//# sourceMappingURL=testFindProductByProductCustomId.js.map