...
const runTestCreateUser = async () => {
    try {
        ...
        const dataUser = {
            ...
            hasTwoFactor: false,
            department: validations_1.objectIdSchema.parse("682e325a174576bd98f15671"),
            roleConfig: validations_1.objectIdSchema.parse("68263fc7f016933bfed2ec24"),
        };
        const idRole = validations_1.objectIdSchema.parse("68263fc7f016933bfed2ec24");
...
//# sourceMappingURL=testCreateUser.js.map