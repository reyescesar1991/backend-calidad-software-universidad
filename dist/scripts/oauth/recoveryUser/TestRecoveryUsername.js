...
const runTestRecoveryUsername = async () => {
    try {
        ...
        const result = await oauthService.confirmUsernameReset({ idUser: idUser });
        console.log("📄 Usuario enviado a su email", result);
    }
    catch (error) {
...
runTestRecoveryUsername().then(() => {
    console.log('Proceso de seed completo');
})
    .catch((error) => {
    console.error('Error durante el proceso de seed:', error);
});
//# sourceMappingURL=TestRecoveryUsername.js.map